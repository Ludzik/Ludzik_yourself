...
// ekran koncowy, na poczatku niewidoczny
...
var top6color1 = $(".top6color1"),
	top6color2 = $(".top6color2"),
	top6color3 = $(".top6color3");

var top8color1 = $(".top8color1"),
	top8color2 = $(".top8color2"),
	top8color3 = $(".top8color3"),
	top8color4 = $(".top8color4");
...
// wszystkie color pickery shoes:
var shoes1color = $("#shoes1color"),
	shoes3color = $("#shoes3color"),
	shoes7color = $("#shoes7color");
// wszystkie probki color shoes:
var shoes1color1 = $(".shoes1color1"),
	shoes1color2 = $(".shoes1color2"),
	shoes1color3 = $(".shoes1color3"),
	shoes1color4 = $(".shoes1color4"),
	shoes1color5 = $(".shoes1color5");

var shoes3color1 = $(".shoes3color1"),
	shoes3color2 = $(".shoes3color2"),
	shoes3color3 = $(".shoes3color3"),
	shoes3color4 = $(".shoes3color4");

var shoes7color1 = $(".shoes7color1"),
	shoes7color2 = $(".shoes7color2");

// wszystkie color pickery gadget:
var gadget2color = $("#gadget2color");
// wszystkie probki color gadget:
...
// top5
		...
		top.attr("src", "images/top5.png");
		allColorPicker.hide();
// top6
	} else if (topIndex == 6 && top.hasClass("color1")){
		top.attr("src", "images/top6color1.png");
		allColorPicker.hide();
		top6color.show();
	} else if (topIndex == 6 && top.hasClass("color2")){
		top.attr("src", "images/top6color2.png");
		allColorPicker.hide();
		top6color.show();
	} else if (topIndex == 6 && top.hasClass("color3")){
		top.attr("src", "images/top6color3.png");
		allColorPicker.hide();
		top6color.show();
	} else if (topIndex == 6){
		top.attr("src", "images/top6color1.png");
...
// top7
		...
		top.attr("src", "images/top7.png");
		allColorPicker.hide();
// top8
	} else if (topIndex == 8 && top.hasClass("color1")){
		top.attr("src", "images/top8color1.png");
		allColorPicker.hide();
		top8color.show();
	} else if (topIndex == 8 && top.hasClass("color2")){
		top.attr("src", "images/top8color2.png");
		allColorPicker.hide();
		top8color.show();
	} else if (topIndex == 8 && top.hasClass("color3")){
		top.attr("src", "images/top8color3.png");
		allColorPicker.hide();
		top8color.show();
	} else if (topIndex == 8 && top.hasClass("color4")){
		top.attr("src", "images/top8color4.png");
		allColorPicker.hide();
		top8color.show();
	} else if (topIndex == 8){
		top.attr("src", "images/top8color1.png");
...
// top8
		...
		top8color.show();
// tu wstaw ostatni obraz:
	} else if (topIndex == -1 && top.hasClass("color1")){
...
nextShoes.on("click", function(){
	shoesIndex +=1;
// shoes1
	if(shoesIndex == 1 && shoes.hasClass("color1")){
		// dopracować animację: show, hide, slideup, slidedown lub animate fade in fade out
		shoes.attr("src", "images/shoes1color1.png");
		allColorPicker.hide();
		shoes1color.show();
	} else if (shoesIndex == 1 && shoes.hasClass("color2")){
		shoes.attr("src", "images/shoes1color2.png");
		allColorPicker.hide();
		shoes1color.show();
	} else if (shoesIndex == 1 && shoes.hasClass("color3")){
		shoes.attr("src", "images/shoes1color3.png");
		allColorPicker.hide();
		shoes1color.show();
	} else if (shoesIndex == 1 && shoes.hasClass("color4")){
		shoes.attr("src", "images/shoes1color4.png");
		allColorPicker.hide();
		shoes1color.show();
	} else if (shoesIndex == 1 && shoes.hasClass("color5")){
		shoes.attr("src", "images/shoes1color5.png");
		allColorPicker.hide();
		shoes1color.show();
...
// shoes2
		...
		allColorPicker.hide();
// shoes3
	} else if(shoesIndex == 3 && shoes.hasClass("color1")){
		shoes.attr("src", "images/shoes3color1.png");
		allColorPicker.hide();
		shoes3color.show();
	} else if (shoesIndex == 3 && shoes.hasClass("color2")){
		shoes.attr("src", "images/shoes3color2.png");
		allColorPicker.hide();
		shoes3color.show();
	} else if (shoesIndex == 3 && shoes.hasClass("color3")){
		shoes.attr("src", "images/shoes3color3.png");
		allColorPicker.hide();
		shoes3color.show();
	} else if (shoesIndex == 3 && shoes.hasClass("color4")){
		shoes.attr("src", "images/shoes3color4.png");
		allColorPicker.hide();
		shoes3color.show();
	} else if (shoesIndex == 3){
		shoes.attr("src", "images/shoes3color1.png");
		...
		shoes3color.show();
// shoes4
	} else if (shoesIndex == 4){
		shoes.attr("src", "images/shoes4.png");
		allColorPicker.hide();
// shoes5
	} else if (shoesIndex == 5){
		shoes.attr("src", "images/shoes5.png");
		allColorPicker.hide();
// shoes6
	} else if (shoesIndex == 6){
		shoes.attr("src", "images/shoes6.png");
		allColorPicker.hide();
// shoes7
	} else if(shoesIndex == 7 && shoes.hasClass("color1")){
		shoes.attr("src", "images/shoes7color1.png");
		allColorPicker.hide();
		shoes7color.show();
	} else if (shoesIndex == 7 && shoes.hasClass("color2")){
		shoes.attr("src", "images/shoes7color2.png");
		allColorPicker.hide();
		shoes7color.show();
	} else if (shoesIndex == 7){
		shoes.attr("src", "images/shoes7color1.png");
		allColorPicker.hide();
		shoes7color.show();
	// ponizej zerujesz do empty
...
// tu wstaw ostatni obraz:
	} else if (shoesIndex == -1 && shoes.hasClass("color1")){
...
doneButton.on("click", function(event){
	...
	doneScreen.css("display", "block").addClass("block");
	// rozblurowanie wszystkiego oprocz tła
	$('body > *:not(#doneScreen)').css("filter", "blur(5px)").css("-webkit-filter", "blur(5px)");
		});

close.on("click", function(event){

	doneScreen.css("display", "none").removeClass("block");
	// rozblurowanie wszystkiego oprocz tła
	$('body > *:not(#doneScreen)').css("filter", "").css("-webkit-filter", "");
		});
...
// enter z klawiatury - Done Button
		if (event.keyCode === 13){
...
// top6color
top6color1.on("click", function(){
	top.attr("src", "images/top6color1.png").removeClass().addClass("color1");
});
top6color2.on("click", function(){
	top.attr("src", "images/top6color2.png").removeClass().addClass("color2");
});
top6color3.on("click", function(){
	top.attr("src", "images/top6color3.png").removeClass().addClass("color3");
});
// top8color
top8color1.on("click", function(){
	top.attr("src", "images/top8color1.png").removeClass().addClass("color1");
});
top8color2.on("click", function(){
	top.attr("src", "images/top8color2.png").removeClass().addClass("color2");
});
top8color3.on("click", function(){
	top.attr("src", "images/top8color3.png").removeClass().addClass("color3");
});
top8color4.on("click", function(){
	top.attr("src", "images/top8color4.png").removeClass().addClass("color4");
});
// bottom1
...
// shoes1
shoes1color1.on("click", function(){
	// zmiana obrazka - usuniecie wszystkich klas - dodanie jedej klasy z kolorem
	shoes.attr("src", "images/shoes1color1.png").removeClass().addClass("color1");
});
shoes1color2.on("click", function(){
	shoes.attr("src", "images/shoes1color2.png").removeClass().addClass("color2");
});
shoes1color3.on("click", function(){
	shoes.attr("src", "images/shoes1color3.png").removeClass().addClass("color3");
});
shoes1color4.on("click", function(){
	shoes.attr("src", "images/shoes1color4.png").removeClass().addClass("color4");
});
shoes1color5.on("click", function(){
	shoes.attr("src", "images/shoes1color5.png").removeClass().addClass("color5");
});
// shoes3
shoes3color1.on("click", function(){
	// zmiana obrazka - usuniecie wszystkich klas - dodanie jedej klasy z kolorem
	shoes.attr("src", "images/shoes3color1.png").removeClass().addClass("color1");
});
shoes3color2.on("click", function(){
	shoes.attr("src", "images/shoes3color2.png").removeClass().addClass("color2");
});
shoes3color3.on("click", function(){
	shoes.attr("src", "images/shoes3color3.png").removeClass().addClass("color3");
});
shoes3color4.on("click", function(){
	shoes.attr("src", "images/shoes3color4.png").removeClass().addClass("color4");
});
// shoes7
shoes7color1.on("click", function(){
	// zmiana obrazka - usuniecie wszystkich klas - dodanie jedej klasy z kolorem
	shoes.attr("src", "images/shoes7color1.png").removeClass().addClass("color1");
});
shoes7color2.on("click", function(){
	shoes.attr("src", "images/shoes7color2.png").removeClass().addClass("color2");
});
// gadget2color
